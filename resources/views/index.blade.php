                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="img_box padding_top0">
                                                <figure><img style="border-radius: 5px" src="images/img.jpg" alt="#" />
                                                </figure>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="white_bg">
                                                <div class="row d_flex">
                                                    ...
                                                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                                                        <div class="img_box">
                                                            <figure><img src="images/img2.jpg" alt="#" />
                                                            </figure>
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            <div class="row d_flex">
                                <div class="col-md-6">
                                    <div class="text-bg">
                                        ...
                                        <h1><strong class="black_bold" style="color: black"> LOMBOK
                                            </strong></h1>
                                ...
                                <div class="col-md-6 padding_right">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="img_box padding_top0">
                                                <figure><img src="images/img_one.jpg" alt="#" /></figure>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="white_bg">
                            ...
                            <div class="row d_flex">
                                ...
                                <div class="col-md-6 padding_right">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="img_box padding_top0">
                                                <figure><img style="border-radius: 5px" src="images/img_two.jpg" alt="#" />
                                                </figure>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="white_bg">
                                                <div class="row d_flex">
                                                    ...
                                                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                                                        <div class="img_box">
                                                            <figure><img style="border-radius: 5px" src="images/img2.jpg"
                                                                    alt="#" />
                                                            </figure>
                                                        </div>
                                                    </div>
                            ...
                            <a href="https://swop.link/cool" target="_blank" class="profile">
                                <p>
                                    ...
                                    <div style="display: flex">
                                        <p> <i class="fa fa-eye" style="color: rgb(83, 63, 12)"></i> 142
                                        </p>
                                        <p> &nbsp;</p>
                                        <p> <i class="fa fa-comments" style="color: rgb(83, 63, 12)"></i> 2
                                        </p>
                                    </div>
                                </p>
