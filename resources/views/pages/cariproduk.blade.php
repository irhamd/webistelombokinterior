                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <form class="news">
                                    <input class="newslatter" placeholder="Cari produk ..." type="text"
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 ">
                                <div class="row">
                                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
                                        <div class="address">
                                            <h3>Kantor Kami </h3>
                                            <a href=""> <img class="logo2" src="images/logo1.png"
                                                    alt="logo"></a>
                                        ...
                                        <div class="address">
                                            ...
                                            <ul class="Links_footer">
                                                ...
                                                <li><a href="#"><i class="fa fa-angle-right"
                                                            aria-hidden="true"></i>Perkantoran </a> </li>
                                                <li><a href="#"><i class="fa fa-angle-right" aria-hidden="true"></i>
                                                        Kamar Tidur</a> </li>
                                                <li><a href="#"><i class="fa fa-angle-right"
                                                            aria-hidden="true"></i>Ruang Kerja </a> </li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
                                        <div class="address">
                                            ...
                                            <ul class="loca">
                                                ...
                                                <li>
                                                    <a href="Javascript:void(0)"><img src="icon/2.png"
                                                            alt="#" /></a>(+62) 813-3188-0750
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-6">
                                <div class="clients_img" style="border-radius: 4px">
                                    ...
                                    <ul class="sociel1">
                                        ...
                                        <li> <a href="Javascript:void(0)"><i class="fa fa-comments-o"
                                    ...
                                    <p>
                                    <h4 class="upper"> <b> Kitchen Set </b> </h4> <br>
